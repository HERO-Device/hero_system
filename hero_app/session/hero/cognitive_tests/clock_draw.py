...
class ClockDraw:
    ...
    def instruction_loop(self):
        ...
        self.touch_screen.load_image("hero/consultation/resources/graphics/instructions/clock_example.png",
    ...
    def entry_sequence(self):
        ...
        if self.parent:
            self.parent.speak_text(f"Set the time to {self.time.strftime('%I:%M')}", display_screen=self.display_screen, touch_screen=self.touch_screen)
        # add code below

...
from hero.consultation.touch_screen import GameObjects, TouchScreen, GameButton
from hero.consultation.utils import ButtonModule, Buttons, take_screenshot
...
class CardGame:
    ...
    def instruction_loop(self):
        ...
        self.touch_screen.load_image("hero/consultation/resources/graphics/instructions/wct_question.png",
        ...
        self.touch_screen.load_image("hero/consultation/resources/graphics/instructions/wct_answer.png",
